...
if(!empty($_POST["register-user"])) {
	...
	if(!isset($error_message)) {
		...
		$query = "INSERT INTO register_users ( first_name, last_name,reg_no, password, email, gender) VALUES
		(' '" . $_POST["firstName"] . "', '" . $_POST["lastName"] . "'," . $_POST["reg_no"] . "', '" . ($_POST["password"]) . "', '" . $_POST["userEmail"] . "', '" . $_POST["gender"] . "')";
...
<form name="frmRegistration" method="post" action="login.php">
